...
const char descriptor_table_protodef_company_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "me\030\003 \002(\t\022\020\n\010activity\030\004 \001(\t\022\027\n\017foreignEco"
  "nomic\030\005 \001(\010"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_company_2eproto = {
  false, false, 131, descriptor_table_protodef_company_2eproto, "company.proto", 
...
Company::Company(const Company& from)
  ...
  ::memcpy(&foundationyear_, &from.foundationyear_,
    ...
    reinterpret_cast<char*>(&foundationyear_)) + sizeof(foreigneconomic_));
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "Company.companyName");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else
          goto handle_unusual;
...
void Company::InternalSwap(Company* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      &activity_, lhs_arena,
      &other->activity_, rhs_arena
  );
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Company, foreigneconomic_)
      + sizeof(Company::foreigneconomic_)
      - PROTOBUF_FIELD_OFFSET(Company, foundationyear_)>(
